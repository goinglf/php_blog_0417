...
<body>
    ...
    <div class="result_wrap">
        ...
        <div class="result_content">
            <ul>
                <li>
                    <label>操作系统</label><span><?php echo php_uname('s');?></span>
                </li>
                <li>
                ...
                <li>
                    <label>服务器域名/IP</label><span><?php echo $_SERVER['SERVER_NAME'] .'/';echo $_SERVER['SERVER_ADDR'];?></span>
                </li>
                <li>
                    <label>Host</label><span><?php echo $_SERVER['REMOTE_ADDR'];?></span>
                </li>
            </ul>
        </div>
    </div>
